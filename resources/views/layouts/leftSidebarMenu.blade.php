  ...
  <aside id="leftsidebar" class="sidebar">
      ...
      <div class="menu">
          <ul class="list">
              ...
              <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-hc-fw"></i><span>Members</span></a>
                  <ul class="ml-menu">
                      <li><a href="{{route('add.members')}}">Add Members</a></li>
                      <li><a href="{{route('members')}}">Members List</a></li>                      
                  </ul>
              </li>
